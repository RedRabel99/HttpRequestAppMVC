        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RequestListId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_HttpResponses_HttpRequests_HttpRequestId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_HttpRequests_RequestListId",
                table: "HttpRequests",
                column: "RequestListId");

            migrationBuilder.CreateIndex(
                name: "IX_HttpResponses_HttpRequestId",
                table: "HttpResponses",
